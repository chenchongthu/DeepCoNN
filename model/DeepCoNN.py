...
tf.flags.DEFINE_string("valid_data","../data/toys/toys.valid", " Data for validation")
tf.flags.DEFINE_string("test_data", "../data/toys/toys.test", "Data for testing")
tf.flags.DEFINE_string("train_data", "../data/toys/toys.train", "Data for training")
tf.flags.DEFINE_string("user_review", "../data/toys/user_review", "User's reviews")
tf.flags.DEFINE_string("item_review", "../data/toys/item_review", "Item's reviews")
