...
import csv
import pickle
tf.flags.DEFINE_string("valid_data","../data/toys/toys2.valid", " Data for validation")
tf.flags.DEFINE_string("test_data", "../data/toys/toys2.test", "Data for testing")
tf.flags.DEFINE_string("train_data", "../data/toys/toys2.train", "Data for training")
...
if __name__ == '__main__':
    ...
    output = open('toys.train', 'wb')
    pickle.dump(batches_train,output)
    output = open('toys.test', 'wb')
